...
In 1992, the Rae government's Rent Control Act limited the kind of capital expenditures landlords could recover via rent increases and once again exempted new rental housing from rent control for a period of 5 years.\cite{^miron-1995} In 1998, the Harris government initiated the most dramatic change since their introduction: capital expenditures could now be fully recovered, vacancy decontrol\footnote{ Vacancy control means rents are controlled between tenancies; the control binds to the dwelling unit and not to the tenant. In a vacancy decontrolled rent control regime, rents are allowed to reset to market rates when a tenants vacate their dwellings. I found this quote by Martine August and Alan Walks months after first drafting this paper, and it's quite revealing: \begin{quote}In 1998, Residential Equities REIT (ResREIT) was launched, with plans to acquire 27 Ontario properties “to more fully benefit from the anticipated relaxation of rent controls in Ontario, with legislation expected to be proclaimed in force in April 1998” (ResREIT, 1997, 4). Quite notably, ResREIT was launched by Dino Chiesa, Assistant Deputy Minister in the Housing Ministry during the time the 1997 Tenant Protection Act (TPA) was conceived. Immediately after, he left public office and started ResREIT to directly profit from new opportunities for rental increases in legislation he helped to craft\end{quote}} was introduced for existing units, and rents in new buildings were permanently deregulated.\footnote{\label{rta-2006} Tenant laws were changed again in 2006, but rent controls were unaffected.} \cite{rent-control-city-report} \cite{^smith-2003}
