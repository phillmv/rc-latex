...
\caption[Ontario Housing Starts by Intended Market and Condos 1969-2016]{Figure 2, but distinguishing condominiums from single, detached and other housing.
}
\label{fig:figure3} 
\end{figure}
